...
FINE_TO_SUPERTYPE: Dict[str, str] = {
    ...
    # Relation types emitted by gpt-5 that weren't in the original
    # gpt-4o-mini-derived map. Backfilled 2026-05-06.
    "SCENE_CAUSATION":            "CAUSAL_PRODUCTION",
    "SCENE_CHAINING":             "CAUSAL_PRODUCTION",
    "PLOT_PROPULSION":            "CAUSAL_PRODUCTION",
    "STRUCTURAL_DEPENDENCE":      "CAUSAL_PRODUCTION",
    "CONSEQUENCE_CHAINING":       "CAUSAL_PRODUCTION",
    "REINFORCES_GOAL":            "CAUSAL_PRODUCTION",
    "OPPOSITION_PRESSURE":        "CAUSAL_CONSTRAINT",
    "PREVENTS_OUTCOME":           "CAUSAL_CONSTRAINT",
    "RELATIONAL_FRAGMENTATION":   "CAUSAL_CONSTRAINT",
    "REVEALS_INFORMATION":        "REVELATION_EPISTEMIC",
    "BACKSTORY_PRESSURE":         "REVELATION_EPISTEMIC",
    "MORAL_REVELATION_TRIGGER":   "REVELATION_EPISTEMIC",
    "MORAL_JUDGMENT":             "REVELATION_EPISTEMIC",
    "PSYCHOLOGICAL_PRESSURE":     "EMOTIONAL_DRIVE",
    "PSYCHOLOGICAL_REINFORCEMENT":"EMOTIONAL_DRIVE",
    "EMOTIONAL_DISTANCE":         "EMOTIONAL_DRIVE",
    "INTERPERSONAL_CARE":         "SOCIAL_BOND",
    "MORAL_GUIDANCE":             "SOCIAL_BOND",
    "INTERPERSONAL_BOUNDARY":     "SOCIAL_BOND",
    "INTERPERSONAL_CONFLICT":     "NARRATIVE_ESCALATION",
    "ESCALATES_CONFLICT":         "NARRATIVE_ESCALATION",
    "SCENE_REVERSAL":             "NARRATIVE_ESCALATION",
    "MORAL_CORRUPTION_INFLUENCE": "NARRATIVE_ESCALATION",
    "LEADS_TO_CRISIS":            "NARRATIVE_ESCALATION",
    "EXPECTED_RESULT_SHIFT":      "NARRATIVE_ESCALATION",
}
